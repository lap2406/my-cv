...
const CV = () => {
  ...
  return (
    <div className="w-screen md:h-screen h-auto md:overflow-hidden snap-y flex cv bg-cover fixed top-0 left-0 right-0 bottom-0 backdrop-blur intro-x">
      <div className="md:w-9/12 w-full md:h-4/6 h-auto p-2 md:p-0 md:absolute md:-translate-x-2/4 md:-translate-y-2/4 top-1/2 left-1/2 bg-white rounded-sm bg-opacity-60 shadow-md md:overflow-hidden overflow-auto">
